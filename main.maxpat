...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 360.0, 530.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 139.0, 717.0, 22.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 238.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 301.0, 818.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 814.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 178.0, 507.0, 32.0, 22.0 ],
					"text" : "/ 80."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 570.0, 90.0, 570.0, 292.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 407.0, 572.0, 290.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 166.0, 577.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 497.0, 41.0, 22.0 ],
					"text" : "scaler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 3.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 16.0, 50.0, 22.0 ],
					"text" : "reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 414.0, 50.0, 49.0 ],
					"text" : "title Document"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 6.0, 48.0, 22.0 ],
					"text" : "readfile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.0, 73.0, 416.0, 391.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 8.0, 416.0, 391.0 ],
					"rendermode" : 0,
					"url" : "file://index.html"
				}
